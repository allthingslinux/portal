import { Book, BookOpen, Video, FileText, GraduationCap, Newspaper, ExternalLink, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="flex-1 space-y-8 p-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Comprehensive collection of Linux learning materials and documentation
          </p>
        </div>
      </div>
      ...
      <Alert variant="default" className="bg-muted border-none">
        ...
        <AlertDescription>
          Want to contribute to our resources? Join our community and help improve our documentation.
        </AlertDescription>
      </Alert>

      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {resources.map((section) => (
          <Card key={section.title} className="flex flex-col bg-card border-muted">
            <CardHeader>
              ...
              <div className="space-y-4">
                {section.items.map((item, index) => (
                  <div key={index} className="group flex flex-col gap-1">
                    ...
                    <Button
                      variant="ghost"
                      className="h-8 px-2 justify-start text-primary hover:text-primary"
                      asChild
                    >
