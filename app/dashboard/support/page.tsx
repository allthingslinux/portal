import { Mail, FileQuestion, Users, Lightbulb, ExternalLink, MessageCircle, Ticket } from 'lucide-react'
...
const supportOptions = [
  ...
  },
  {
    ...
    description: "Find answers to common questions in our extensive documentation",
    icon: FileQuestion,
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Yes, our platform is fully responsive and can be accessed on smartphones and tablets through your web browser. We also have mobile apps available for iOS and Android."
  },
  {
    question: "How often is the content updated?",
    answer: "We update our content regularly. Major updates are typically released on a monthly basis, while minor updates and bug fixes are pushed more frequently."
  },
  {
    question: "Is there a limit to how many projects I can create?",
    answer: "The number of projects you can create depends on your subscription plan. Free users can create up to 3 projects, while paid plans offer unlimited projects."
  },
  {
        ...
        {supportOptions.map((option) => (
          <Card key={option.title} className="flex flex-col">
            ...
            <CardContent className="flex-grow">
              ...
              <p className="mt-2 text-sm text-muted-foreground">{option.availability}</p>
            </CardContent>
            <CardFooter>
