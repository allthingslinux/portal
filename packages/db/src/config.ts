...
// Load .env from the app directory (apps/portal/.env)
// drizzle-kit runs from packages/db/, so we need to resolve the path
config({ path: resolve(import.meta.dirname, "../../../apps/portal/.env") });
