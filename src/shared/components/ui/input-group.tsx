...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    /* biome-ignore lint/a11y/useSemanticElements: interactive wrapper focusing associated input */
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    /* biome-ignore lint/a11y/useSemanticElements: grouping addon content for input */
    <div
